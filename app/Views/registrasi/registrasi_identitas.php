    ...
    <div class="card o-hidden shadow-lg my-5">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs">
                ...
                <?php } else { ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url() ?>/users/identitas">Identitas</a>
                    </li>
                <?php } ?>
            ...
            <div class="d-flex justify-content-between bd-highlight">
                ...
                <div class="p-5 bd-highlight"><button type="button" class="btn btn-outline-info" onclick="location.href='<?= base_url() ?>/users/kelas'"><i class="fas fa-forward"></i> Selanjutnya</button></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function edit_identitas() {
        ...
        $.ajax({
            url: "<?= base_url('users/identitas/view'); ?>",
            type: "GET",
            dataType: "JSON",
    ...
    function saveidentitas() {
        var url;
        if (save_method == 'add') {
            url = "<?= base_url('users/identitas/add'); ?>";
        } else {
            url = "<?= base_url('users/identitas/add'); ?>";
        }
