    ...
    <div class="card o-hidden shadow-lg my-5">
        ...
        <div class="card-body">
            ...
            <div class="card w-50 mx-auto">
                <div class="card-body">
                    <div class="alert alert-primary text-center" role="alert">
                        <h8 class="card-title"><b>IDENTITAS SEKOLAH 1</b></h8>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
            ...
            <div class="d-flex justify-content-between bd-highlight">
                ...
                <div class="p-5 bd-highlight"><button type="button" class="btn btn-outline-info" onclick="location.href='<?= base_url() ?>/users/guru'"><i class="fas fa-forward"></i> Selanjutnya</button></div>
            </div>
...
<script>
    ...
    function edit_sekolah(id) {
        ...
        $.ajax({
            url: "<?= base_url('users/sekolah/edit'); ?>",
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                console.log(data);
    ...
    function save() {
        var url;
        if (save_method == 'add') {
            url = "<?= base_url('users/sekolah/add'); ?>";
        } else {
            url = "<?= base_url('users/sekolah/update'); ?>";
        }
