...
<div class="container">
    ...
    <div class="card my-1 shadow-lg mx-auto">
        <div class="card-body">
            <button type="button" class="btn btn-outline-info" onclick="location.href='<?= base_url('modul/guru'); ?>'"><i class="fas fa-backward"></i> Kembali</button>
            <br /><br />
...
<script>
    var viewer = $('#viewpdf');
    PDFObject.embed('/file/<?php echo $getfile->link ?>', viewer);
</script>
